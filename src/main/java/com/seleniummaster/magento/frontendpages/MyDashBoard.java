...
public class MyDashBoard {
    ...
    // Page factory
    public void MyDashBoardPage(WebDriver driver){
        this.driver=driver;
    ...
    public void myDashBoardPage(WebDriver driver) {
        ...
        clickAddressBook();
        clickMyOrders();
        clickBillingAgreements();
        clickRecurringProfiles();
        clickProductreviewlink();
        clickMyTags();
        clickMyWishList();
        clickMyApplication();
        clickNewsLetterSubscription();
        clickDownloadableProducts();
        clickChangePassword();
        clickCheckOut();
        clickEditNewsLetter();
        clickLogOut();
